        ...
        <div
          ...
          <div className="px-6 py-5">
            <div className="flex items-center justify-between mb-5">
              ...
              <button
                onClick={onClose}
                className="w-7 h-7 flex items-center justify-center hover:bg-white/5 rounded-sm"
                style={{ color: "#8fa88a" }}>
                <X size={16} />
              </button>
            </div>
            <div className="space-y-3 text-xs leading-relaxed" style={{ color: "#a8c4a0" }}>
              ...
              <p>
                <strong style={{ color: "#c8892a" }}>Rat vs Elephant:</strong> Rat captures Elephant on land. Rat in
                water cannot capture Elephant on land.
              </p>
              <p>
                <strong style={{ color: "#c8892a" }}>Win:</strong> Move any piece into the opponent&apos;s den, or
                capture all their pieces.
              </p>
            </div>
          </div>
        </div>
